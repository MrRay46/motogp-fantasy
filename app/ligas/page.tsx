...
export default function LigasPage() {
  ...
  async function seleccionarLiga(ligaId: number) {
    if (!usuario) return;
    ...
    try {
      ...
      const respuesta = await fetch("/api/ligas/seleccionar", {
        method: "POST",
        headers: {
      ...
      if (!respuesta.ok) {
        console.error("Error al seleccionar liga:", resultado);
        setError(resultado.error || "No se pudo cambiar de liga.");
        return;
      }

      const usuarioActualizado = {
        ...usuario,
        liga_actual_id: resultado.liga_actual_id,
      };
      ...
      console.error("Error al seleccionar liga:", err);
      setError("Error de conexión al cambiar de liga.");
    }
  }
